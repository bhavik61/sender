...
def homeView(request):
	...
	#	if email.emailList == None:
	#		email.delete()

	'''
	if email_list != "<QuerySet []>":
		delete_email = EmailList.objects.filter(user = u).last()

		if delete_email.emailList == "None":
			delete_email.delete()
		'''
...
def helpView(request):
	return render(request, "help.html", {'help' : "active"})
